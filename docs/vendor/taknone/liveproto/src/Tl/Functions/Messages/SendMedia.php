...
/**
 * @param inputpeer peer inputmedia media string message long random_id true silent true background true clear_draft true noforwards true update_stickersets_order true invert_media true allow_paid_floodskip inputreplyto reply_to replymarkup reply_markup Vector<MessageEntity> entities int schedule_date inputpeer send_as inputquickreplyshortcut quick_reply_shortcut long effect long allow_paid_stars suggestedpost suggested_post
 * @return Updates
 */

final class SendMedia extends Instance {
	public function request(object $peer,object $media,string $message,int $random_id,? true $silent = null,? true $background = null,? true $clear_draft = null,? true $noforwards = null,? true $update_stickersets_order = null,? true $invert_media = null,? true $allow_paid_floodskip = null,? object $reply_to = null,? object $reply_markup = null,? array $entities = null,? int $schedule_date = null,? object $send_as = null,? object $quick_reply_shortcut = null,? int $effect = null,? int $allow_paid_stars = null,? object $suggested_post = null) : Binary {
		$writer = new Binary(true);
		$writer->writeInt(0xac55d9c1);
		$flags = 0;

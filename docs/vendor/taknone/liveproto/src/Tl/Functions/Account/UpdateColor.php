...
/**
 * @param true for_profile int color long background_emoji_id
 * @return Bool
 */

final class UpdateColor extends Instance {
	public function request(? true $for_profile = null,? int $color = null,? int $background_emoji_id = null) : Binary {
		$writer = new Binary(true);
		$writer->writeInt(0x7cefa15d);
		$flags = 0;
